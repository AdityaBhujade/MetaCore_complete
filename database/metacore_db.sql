...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2025 at 12:40 PM
...
(1, 'MetaCore', 'Harpur road, Kaswa Kherhi, Shakund, Bhagalpur, Bihar, 813108', '1234567890', 'metacorebgp@gmail.com', '2025-06-10 02:55:40');
...
(2, 'aditya', 40, 'Male', '987654321', '', 'PAT000002', 'mumbai', 'Dr. Rahul', '2025-06-10 03:10:57'),
(3, 'Sumit', 50, 'Male', '878895616514', 'sumit@gmail.com', 'PAT000003', 'nagpur besa', 'Dr. Rahul', '2025-06-10 23:57:19'),
(4, 'alia', 10, 'Female', '12316585481', 'alia@gmail.com', 'PAT000004', 'mumbai', 'Dr. Geet', '2025-06-10 23:57:48'),
(5, 'natalie', 42, 'Other', '1057358449', 'naatalie@gmail.com', 'PAT000005', 'usa', 'Dr. Rita', '2025-06-10 23:58:20'),
(8, 'riya roy', 23, 'Female', '4561236979', 'xyz@gmail.com', 'PAT000007', 'gotham', 'Dr. Radhika', '2025-06-13 12:39:48'),
(9, 'Chintu Singh', 25, 'Male', '7655418552', '', 'PAT000008', 'Tamil Nadu', 'Dr. Geet', '2025-06-13 20:16:08');
...
(3, 1, 'Profile', 'Biochemistry Profile', 'Thyroid Profile', '20', '', '', '2025-06-12 18:30:00', 'all ok', '2025-06-13 11:51:02'),
...
(1, 'admin@metacore.com', '$2b$12$ss3KZdKc4C8mTg7pVl7AT.V2A5eJD7q9kB1ktm8sdX.nvjrjRS1ia', 'Admin User', NULL, 'admin', '2025-06-13 10:22:55');
...
--
ALTER TABLE `tests`
  ADD CONSTRAINT `tests_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`);
COMMIT;
